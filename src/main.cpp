...
void DisplayMainPosts ()
{
	...
	/*glPushMatrix();
		glTranslatef(-2348.0, 0.0, 10000.0);
	glutSolidCube(1000000);
	glPopMatrix();*/
	//POSTS FOR Banner Face
	/*	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(MAIN_POST));
	glPushMatrix();
		glTranslatef(-2348.0, 0.0, 10000.0);
	glCallList(51);
	glPopMatrix();
	glPushMatrix();
		glTranslatef(-2348.0, 0.0, 10128.0);
		glCallList(51);
	glPopMatrix();
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(MAIN_POST_2));
	glPushMatrix();
	glTranslatef(-2220.0, 0.0, 10000.0);
	glCallList(52);
	glPopMatrix();
	glPushMatrix();
		glTranslatef(-2348.0, 0.0, 10000.0);
	...
	glPopMatrix();*/
			...
			/*glBindTexture(GL_TEXTURE_2D, tp.GetTexture(MAIN_POST));
	glPushMatrix();
		glTranslatef(-3028.0, 0.0, 10000.0);
	glCallList(51);
	glPopMatrix();
	glPushMatrix();
		glTranslatef(-3028.0, 0.0, 10128.0);
		glCallList(51);
	glPopMatrix();
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(MAIN_POST_2));
	glPushMatrix();
	glTranslatef(-2900.0, 0.0, 10000.0);
	glCallList(52);
	glPopMatrix();
	glPushMatrix();
		glTranslatef(-3028.0, 0.0, 10000.0);
	...
	glCallList(310);
	glPushMatrix();
		glTranslatef(1280.0, 20000.0, 0.0);
		glCallList(310);
	glPopMatrix();
		
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(251));
	glPushMatrix();
		glTranslatef(20600.0, 300.0, -24940.0);
