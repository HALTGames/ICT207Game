...
void ShaysWorld::Keyboard(unsigned char key, int x, int y)
{
	int i = 0;
	switch (key)
	{
...
void ShaysWorld::Mouse(int button, int state, int x, int y)
{
...
void ShaysWorld::CreateNewBoundingBoxes()
{
	//Mine
	/*cam.SetAABBMaxX(17, 20000.0);
	cam.SetAABBMinX(17, 0.0);
	cam.SetAABBMaxZ(17, 45000.0);
	cam.SetAABBMinZ(17, 43000.0);*/


	//added room bounding boxes
	/*cam.SetAABBMaxX(3, 35879.0);
	cam.SetAABBMinX(3, 34256.0);
	cam.SetAABBMaxZ(3, 27559.0);
	cam.SetAABBMinZ(3, /*26752.0*/// 27300);
	
	//5.18 wall on right of entrance
	cam.SetAABBMaxX(17, 36136.0);
	cam.SetAABBMinX(17, 34206.0);
	cam.SetAABBMaxZ(17, 27800.0);
	cam.SetAABBMinZ(17, 27660.0);

	
	//left segment beside entrance door
	cam.SetAABBMaxX(18, 34150.0);
	cam.SetAABBMinX(18, 33900.0);
	cam.SetAABBMaxZ(18, 26800.0);
	cam.SetAABBMinZ(18, 25000.0);

	//right segment beside entrance door
	cam.SetAABBMaxX(19, 34286.0);
	cam.SetAABBMinX(19, 33808.0);
	cam.SetAABBMaxZ(19, 28160.0);
	cam.SetAABBMinZ(19, 27559.0);

	//Left wall of entrance
	/*cam.SetAABBMaxX(20, 36776.0);
	cam.SetAABBMinX(20, 34286.0);
	cam.SetAABBMaxZ(20, 25730.0);
	cam.SetAABBMinZ(20, 25000.0);*/

	//huge right wall
	cam.SetAABBMaxX(21, 36136.0);
	cam.SetAABBMinX(21, 35900.0);
	cam.SetAABBMaxZ(21, 35960.0);
	cam.SetAABBMinZ(21, /*28160.0*/27800.0);

	//right side end
	
	cam.SetAABBMaxX(22, 39336.0);
	cam.SetAABBMinX(22, 36136.0);
	cam.SetAABBMaxZ(22, 30600.0);
	cam.SetAABBMinZ(22, 30460.0);
	
	//far 5.94 metre wall
	cam.SetAABBMaxX(23, 43636.0);
	cam.SetAABBMinX(23, 37000.0);
	cam.SetAABBMaxZ(23, 30460.0);
	cam.SetAABBMinZ(23, 28400.0);

	//right side of top door indent 1.64 meters
	cam.SetAABBMaxX(24, 44276.0);
	cam.SetAABBMinX(24, 37000.0);
	cam.SetAABBMaxZ(24, 30150.0);
	cam.SetAABBMinZ(24, 28400.0);

	//far doorway 2.17 meter
	cam.SetAABBMaxX(25, 44376.0);
	cam.SetAABBMinX(25, 37700.0);
	cam.SetAABBMaxZ(25, 28400.0);
	cam.SetAABBMinZ(25, 26850.0);

	//left side of top door indent 1.64 meters
	cam.SetAABBMaxX(26, 44276.0);
	cam.SetAABBMinX(26, 37000.0);
	cam.SetAABBMaxZ(26, 27650.0);
	cam.SetAABBMinZ(26, 27450.0);


	//3.29 meter wall on the left of the door indent
	cam.SetAABBMaxX(27, 42736.0);
	cam.SetAABBMinX(27, 37000.0);
	cam.SetAABBMaxZ(27, 27650.0);
	cam.SetAABBMinZ(27, 24460.0);

	//3.44 meter wall
	cam.SetAABBMaxX(28, 37000.0);
	cam.SetAABBMinX(28, 35900.0);
	cam.SetAABBMaxZ(28, 26560.0);
	cam.SetAABBMinZ(28, 26040.0);

	//2.86 meter
	cam.SetAABBMaxX(29, 39496.0);
	cam.SetAABBMinX(29, 35900.0);
	cam.SetAABBMaxZ(29, 26560.0);
	cam.SetAABBMinZ(29, 21600.0);

	//3.98 meter wall
	cam.SetAABBMaxX(30, 35900.0);
	cam.SetAABBMinX(30, 34216.0);
	cam.SetAABBMaxZ(30, 25500.0);
	cam.SetAABBMinZ(30, 25100.0);

	//wall between door and stairs
	cam.SetAABBMaxX(31, 35500.0);
	cam.SetAABBMinX(31, 33780.0);
	cam.SetAABBMaxZ(31, 26680.0);
	cam.SetAABBMinZ(31, 26520.0);

	//stair bannisters
	cam.SetAABBMaxX(32, 35300.0);
	cam.SetAABBMinX(32, 34320.0);
	cam.SetAABBMaxZ(32, 26050.0);
	cam.SetAABBMinZ(32, 25950.0);	
}
...
{	
	...
	cam.SetPlains (FLAT_PLAIN, 0.0, 33000.0 , 10450.0, 10450.0, 10000.0, 17000.0);
	cam.SetPlains (FLAT_PLAIN, 0.0, 6500.0 , 10450.0, 10450.0, 17000.0, 40000.0);
	cam.SetPlains (FLAT_PLAIN, 27000.0, 33000.0 , 10450.0, 10450.0, 17000.0, 40000.0);
	cam.SetPlains (FLAT_PLAIN, 0.0, 33000.0 , 10450.0, 10450.0, 40000.0, 50000.0);
...
void ShaysWorld::CreateNewPlains()
{
	cam.SetPlains (XY_PLAIN, 34300.0, 35300.0, 10950.0, 10500.0, 25560.0, 25900.0);
	
	cam.SetPlains (XY_PLAIN, 34300.0, 35300.0, 10950.0, 11450.0, 26050.0, 26560.0);
}
...
void ShaysWorld::CreateTextures()
{
	...
	image = tp.LoadTexture("data/hamish.raw", 690, 903);
	tp.CreateTexture(251, image, 690, 903);
	...
	image = tp.LoadTexture("data/island.raw", 256, 256);
	tp.CreateTexture(253, image, 256, 256);
...
void ShaysWorld::DrawAngledRoofBeam (int listNo, GLdouble x, GLdouble y, GLdouble z, GLdouble beamSize)
{
...
void ShaysWorld::DrawAngledRoofBeam2 (int listNo, GLdouble x, GLdouble y, GLdouble z, GLdouble beamSize)
{
	glNewList(listNo, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2f(0.0, 0.0);
...
void ShaysWorld::drawmodel_box()
{
	...
	//	glTranslatef(0,0,0);
		//glScalef(1,1,1);
		//glmDraw(wallfix, GLM_SMOOTH| GLM_TEXTURE);
	//glPopMatrix();
}
...
void ShaysWorld::transition(void)
{
	glPushMatrix();
	glBegin(GL_QUADS);
		glVertex3f(36000.0, 10900.0, 26560.0);
		glVertex3f(36000.0, 12500.0, 26560.0);
		glVertex3f(36000.0, 12500.0, 25500.0);
		glVertex3f(36000.0, 10900.0, 25500.0);
	glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glTranslatef(35900.0, 11635.0, 26070.0);
		glScalef(40,75,80);
		glRotatef(90.0, 0.0, 1.0, 0.0);
		wave.renderWave();
	glPopMatrix();
