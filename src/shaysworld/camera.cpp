...
Camera::Camera()
{
	...
	walkSound = es->GetSound(es->Load("sounds/Footsteps1.wav"));
...
void Camera::CheckTrans()
{
//	if((m_x>35745)&&(m_z<26500)&&(m_z>21600)&&(m_y>10600))
